                ...
                <div className="flex gap-4">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-1">
                            <ArrowBendDownLeft size={16} /><span className="text-zinc-500 text-xs">topico publicado <strong className="font-semibold">há 5 dias</strong> </span>
                        </div>
                    </div>
                </div>

                <button><Trash className="text-red-500" size={28} /></button>
            </div>
